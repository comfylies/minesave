<template>
  <div class="admin-cleanup">
    <h2 class="admin-page-title">失败存档清理</h2>
    <p class="admin-page-desc">清理因网络中断、解压失败等原因产生的无效存档文件和数据库记录，释放磁盘空间。</p>
        ...
        <el-card shadow="hover" class="admin-stat-card">
          <div class="admin-stat-content">
            ...
            <div class="admin-stat-info">
              <div class="admin-stat-value danger">{{ status.totalDeleted }}</div>
              <div class="admin-stat-label">已删除总数</div>
            </div>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="12">
        <el-card shadow="hover" class="admin-stat-card">
          <div class="admin-stat-content">
            ...
            <div class="admin-stat-info">
              <div class="admin-stat-value">{{ status.batchesCompleted }}</div>
              <div class="admin-stat-label">已完成批次</div>
            </div>
          </div>
        </el-card>
      </el-col>
    ...
    <el-card shadow="hover" class="admin-card-row">
      <template #header>
        <span class="admin-card-header-title">手动清理</span>
      </template>
    ...
    <el-card shadow="hover">
      <template #header>
        <span class="admin-card-header-title">当前配置</span>
      </template>
