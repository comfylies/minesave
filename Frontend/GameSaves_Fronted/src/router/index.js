...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'favorites', name: 'Favorites', component: () => import('../views/FavoritesPage.vue'), meta: { requiresAuth: true, wide: true } },
      { path: 'following', name: 'Following', component: () => import('../views/FollowingPage.vue'), meta: { requiresAuth: true, wide: true } },
