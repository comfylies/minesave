...
function choose(event){ const file=event.target.files?.[0]; if(file && file.size>5*1024*1024){ElMessage.error('图片不能超过 5 MB');event.target.value='';return} image.value=file||null }
